        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center">
              <Image src="/images/VESAL VISUALS LOGO (Black).png" alt="Vesal Visuals" width={60} height={60} />
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link href="/gallery" className="text-navy hover:text-navy-light transition-colors">
              Gallery
            </Link>
